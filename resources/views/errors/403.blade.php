...
<body>
  <section id="not-found">
    <div id="title">Error &bull; </div>
    <div class="circles">
      <p>403<br>
       <small>usted no esta autorizado</small>
      </p>

      <span class="circle big"></span>
      <span class="circle med"></span>
      <span class="circle small"></span>
     <input type="button" id="location" class="confondo" onclick="history.back()" name="volver atrás" value="volver atrás">
